...
This is a Tree directive for Angular JS apps that is based 90% on [Nick Perkin's angular-bootstrap-nav-tree](https://github.com/nickperkinslondon/angular-bootstrap-nav-tree).
